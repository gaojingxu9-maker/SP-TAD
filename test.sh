...
# # MSL
# python main.py --anormly_ratio 1.0 --num_epochs 100 --batch_size 128 --mode train --dataset MSL --data_path ./data/MSL/MSL/ --input_c 55 --output_c 55 --n_memory 10 --lambd 0.01 --lr 1e-4 --memory_initial False --phase_type None

# python main.py --anormly_ratio 1.0 --num_epochs 100  --batch_size 128  --mode memory_initial --dataset MSL  --data_path ./data/MSL/MSL/  --input_c 55 --output_c 55 --n_memory 10 --lambd 0.01 --lr 5e-5 --memory_initial True --phase_type second_train

# # test
# python main.py --anormly_ratio 1.0 --num_epochs 10   --batch_size 128  --mode test --dataset MSL  --data_path ./data/MSL/MSL/  --input_c 55 --output_c 55 --n_memory 10 --memory_initial False --phase_type test
